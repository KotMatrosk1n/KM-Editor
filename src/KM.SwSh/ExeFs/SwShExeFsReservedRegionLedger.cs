...
internal static class SwShExeFsReservedRegionLedger
{
    ...
    [
        ...
        // are protected dependencies only; uninstall never restores bytes that Catch Cap did not write.
        new(OwnerCatchCap, "catch-cap-hook-site", ExeFsMainPath, "main.text", 0x013AE3AC, 0x04, "Catch Cap Sword display hook branch site", "do-not-overwrite"),
        new(OwnerCatchCap, "catch-cap-table", ExeFsMainPath, "main.text", 0x013AE3B0, 0x09, "Catch Cap Sword nine-byte cap table", "payload-only"),
        new(OwnerCatchCap, "catch-cap-marker", ExeFsMainPath, "main.text", 0x013AE3B9, 0x07, "Catch Cap Sword marker/version", "do-not-overwrite"),
        new(OwnerCatchCap, "catch-cap-reserved-metadata", ExeFsMainPath, "main.text", 0x013AE3C0, 0x08, "Catch Cap Sword reserved metadata", "do-not-overwrite"),
        new(OwnerCatchCap, "catch-cap-return", ExeFsMainPath, "main.text", 0x013AE3C8, 0x08, "Catch Cap Sword protected display epilogue", "requires-vanilla"),
        new(OwnerCatchCap, "catch-cap-runtime-gate", ExeFsMainPath, "main.text", 0x013AE3DC, 0x18, "Catch Cap Sword runtime capture gate", "do-not-overwrite"),
        new(OwnerCatchCap, "catch-cap-runtime-return", ExeFsMainPath, "main.text", 0x013AE3F4, 0x08, "Catch Cap Sword protected runtime epilogue", "requires-vanilla"),
        new(OwnerCatchCap, "catch-cap-cave-1", ExeFsMainPath, "main.text", 0x013AE0B4, 0x0C, "Catch Cap Sword standard cave slot 1", "do-not-allocate"),
        new(OwnerCatchCap, "catch-cap-cave-2", ExeFsMainPath, "main.text", 0x013AEBE4, 0x0C, "Catch Cap Sword standard cave slot 2", "do-not-allocate"),
        new(OwnerCatchCap, "catch-cap-cave-3", ExeFsMainPath, "main.text", 0x013AD734, 0x0C, "Catch Cap Sword standard cave slot 3", "do-not-allocate"),
        new(OwnerCatchCap, "catch-cap-cave-4", ExeFsMainPath, "main.text", 0x013AF464, 0x0C, "Catch Cap Sword fallback cave slot 1", "do-not-allocate"),
        new(OwnerCatchCap, "catch-cap-shield-hook-site", ExeFsMainPath, "main.text", 0x013AE3DC, 0x04, "Catch Cap Shield display hook branch site", "do-not-overwrite"),
        new(OwnerCatchCap, "catch-cap-shield-table", ExeFsMainPath, "main.text", 0x013AE3E0, 0x09, "Catch Cap Shield nine-byte cap table", "payload-only"),
        new(OwnerCatchCap, "catch-cap-shield-marker", ExeFsMainPath, "main.text", 0x013AE3E9, 0x07, "Catch Cap Shield marker/version", "do-not-overwrite"),
        new(OwnerCatchCap, "catch-cap-shield-reserved-metadata", ExeFsMainPath, "main.text", 0x013AE3F0, 0x08, "Catch Cap Shield reserved metadata", "do-not-overwrite"),
        new(OwnerCatchCap, "catch-cap-shield-return", ExeFsMainPath, "main.text", 0x013AE3F8, 0x08, "Catch Cap Shield protected display epilogue", "requires-vanilla"),
        new(OwnerCatchCap, "catch-cap-shield-runtime-gate", ExeFsMainPath, "main.text", 0x013AE40C, 0x18, "Catch Cap Shield runtime capture gate", "do-not-overwrite"),
        new(OwnerCatchCap, "catch-cap-shield-runtime-return", ExeFsMainPath, "main.text", 0x013AE424, 0x08, "Catch Cap Shield protected runtime epilogue", "requires-vanilla"),
        new(OwnerCatchCap, "catch-cap-shield-cave-1", ExeFsMainPath, "main.text", 0x013AE0E4, 0x0C, "Catch Cap Shield standard cave slot 1", "do-not-allocate"),
        new(OwnerCatchCap, "catch-cap-shield-cave-2", ExeFsMainPath, "main.text", 0x013AEC14, 0x0C, "Catch Cap Shield standard cave slot 2", "do-not-allocate"),
        new(OwnerCatchCap, "catch-cap-shield-cave-3", ExeFsMainPath, "main.text", 0x013AD764, 0x0C, "Catch Cap Shield standard cave slot 3", "do-not-allocate"),
        new(OwnerCatchCap, "catch-cap-shield-cave-4", ExeFsMainPath, "main.text", 0x013AF494, 0x0C, "Catch Cap Shield fallback cave slot 1", "do-not-allocate"),
