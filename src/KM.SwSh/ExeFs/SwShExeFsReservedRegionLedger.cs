...
internal static class SwShExeFsReservedRegionLedger
{
    ...
    [
        ...
        new(OwnerIvScreen, "iv-screen-normal-value-source-01", ExeFsMainPath, "main.text", 0x0138FBE8, 0x04, "IV Screen normal graph value source 01", "do-not-overwrite"),
        new(OwnerIvScreen, "iv-screen-normal-value-source-02", ExeFsMainPath, "main.text", 0x0138FC38, 0x04, "IV Screen normal graph value source 02", "do-not-overwrite"),
        new(OwnerIvScreen, "iv-screen-normal-value-source-03", ExeFsMainPath, "main.text", 0x0138FC74, 0x04, "IV Screen normal graph value source 03", "do-not-overwrite"),
        new(OwnerIvScreen, "iv-screen-normal-value-source-04", ExeFsMainPath, "main.text", 0x0138FC9C, 0x04, "IV Screen normal graph value source 04", "do-not-overwrite"),
        new(OwnerIvScreen, "iv-screen-normal-value-source-05", ExeFsMainPath, "main.text", 0x0138FD2C, 0x04, "IV Screen normal graph value source 05", "do-not-overwrite"),
        new(OwnerIvScreen, "iv-screen-normal-value-source-06", ExeFsMainPath, "main.text", 0x0138FD5C, 0x04, "IV Screen normal graph value source 06", "do-not-overwrite"),
        new(OwnerIvScreen, "iv-screen-normal-value-source-07", ExeFsMainPath, "main.text", 0x0138FD84, 0x04, "IV Screen normal graph value source 07", "do-not-overwrite"),
        new(OwnerIvScreen, "iv-screen-normal-value-source-08", ExeFsMainPath, "main.text", 0x0138FEA0, 0x04, "IV Screen normal graph value source 08", "do-not-overwrite"),
        ...
        new(OwnerIvScreen, "iv-screen-value-pane-visible-flag", ExeFsMainPath, "main.text", 0x0138B1FC, 0x04, "IV Screen value-pane visibility flag", "do-not-overwrite"),
        new(OwnerIvScreen, "iv-screen-value-pane-visible-mask", ExeFsMainPath, "main.text", 0x0138B200, 0x04, "IV Screen value-pane visibility mask", "do-not-overwrite"),
        new(OwnerIvScreen, "iv-screen-hook-site", ExeFsMainPath, "main.text", 0x01392EA8, 0x04, "IV Screen summary renderer wrapper primary call", "do-not-overwrite"),
        new(OwnerIvScreen, "iv-screen-renderer-wrapper-call-02", ExeFsMainPath, "main.text", 0x01393310, 0x04, "IV Screen summary renderer wrapper call 02", "do-not-overwrite"),
        new(OwnerIvScreen, "iv-screen-renderer-wrapper-call-03", ExeFsMainPath, "main.text", 0x0139EF4C, 0x04, "IV Screen summary renderer wrapper call 03", "do-not-overwrite"),
        new(OwnerIvScreen, "iv-screen-x-yellow-bypass", ExeFsMainPath, "main.text", 0x0139FB60, 0x04, "IV Screen X-toggle yellow graph bypass branch", "do-not-overwrite"),
