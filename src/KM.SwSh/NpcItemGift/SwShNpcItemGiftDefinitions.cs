...
internal static class SwShNpcItemGiftDefinitions
{
    ...
    [
        ...
        Gift("lab-guide-wedgehurst-potion", "guide", "Guide", "Guide (Wedgehurst Pokemon Lab)", "Wedgehurst", 20, "main_event_0215.amx", 2845, 1, Slot("item", "Potion", 2846, 17)),
        Gift("leon-route-2-poke-ball", "leon", "Leon", "Leon (Route 2)", "Route 2", 30, "main_event_0250.amx", 6119, 20, Slot("item", "Poke Ball", 6120, 4)),
        Gift("leon-postwick-endorsement", "leon", "Leon", "Leon (Postwick endorsement)", "Postwick", 40, "main_event_0300.amx", 5758, 1, Slot("item", "Endorsement", 5759, 1074)),
        Gift("professor-magnolia-route-2-dynamax-band", "professor-magnolia", "Professor Magnolia", "Professor Magnolia (Route 2)", "Route 2", 50, "main_event_0330.amx", 6232, 1, Slot("item", "Dynamax Band", 6233, 1077)),
        Gift("hop-route-2-tm40", "hop", "Hop", "Hop (Route 2)", "Route 2", 60, "main_event_0340.amx", 6059, 1, Slot("item", "TM40", 6060, 367)),
        Gift("mum-wedgehurst-camping-gear", "mum", "Mum", "Mum (Wedgehurst Station)", "Wedgehurst Station", 70, "main_event_0350.amx", 6095, 1, Slot("item", "Camping Gear", 6096, 1100)),
        ...
        Gift("sonia-wild-area-station-box-link", "sonia", "Sonia", "Sonia (Wild Area Station)", "Wild Area Station", 80, "main_event_0370.amx", 6854, 1, Slot("item", "Pokemon Box Link", 6855, 1075)),
        Gift("leon-motostoke-starter-held-item", "leon", "Leon", "Leon (Motostoke)", "Motostoke", 90, "main_event_0412.amx", 4823, 1,
            [
                Slot("water-starter", "Water starter", 4824, 243),
                Slot("fire-starter", "Fire starter", 4825, 249),
                Slot("grass-starter", "Grass starter", 4826, 239),
            ]),
        Gift("sonia-route-3-escape-rope", "sonia", "Sonia", "Sonia (Route 3)", "Route 3", 100, "main_event_0530.amx", 3621, 1, Slot("item", "Escape Rope", 3622, 78)),
        Gift("gym-attendant-turffield-revive", "gym-attendant", "Gym Attendant", "Gym Attendant (Turffield Gym)", "Turffield Stadium", 110, "main_event_0570.amx", 4360, 2, Slot("item", "Revive", 4361, 28)),
        Gift("milo-turffield-tm10", "milo", "Milo", "Milo (Turffield Gym)", "Turffield Stadium", 120, "main_event_0610.amx", 8556, 1, Slot("item", "TM10", 8557, 337)),
        Gift("bike-doctor-route-5-rotom-bike", "bike-doctor", "Bike Doctor", "Bike Doctor (Route 5)", "Route 5", 130, "main_event_0620.amx", 5959, 1, Slot("item", "Rotom Bike", 5960, 1081)),
        Gift("hop-route-5-revive", "hop", "Hop", "Hop (Route 5)", "Route 5", 140, "main_event_0630.amx", 5931, 1, Slot("item", "Revive", 5932, 28)),
        Gift("nessa-hulbury-tm36", "nessa", "Nessa", "Nessa (Hulbury Gym)", "Hulbury Stadium", 150, "main_event_0670.amx", 8159, 1, Slot("item", "TM36", 8160, 363)),
        Gift("sonia-hulbury-tm79", "sonia", "Sonia", "Sonia (Hulbury)", "Hulbury", 160, "main_event_0690.amx", 2774, 1, Slot("item", "TM79", 2775, 406)),
        Gift("marnie-motostoke-burn-heal", "marnie", "Marnie", "Marnie (Motostoke)", "Motostoke", 170, "main_event_0750.amx", 4802, 2, Slot("item", "Burn Heal", 4803, 19)),
        Gift("kabu-motostoke-tm38", "kabu", "Kabu", "Kabu (Motostoke Gym)", "Motostoke Stadium", 180, "main_event_0800.amx", 5979, 1, Slot("item", "TM38", 5980, 365)),
        Gift("sonia-hammerlocke-revive", "sonia", "Sonia", "Sonia (Hammerlocke)", "Hammerlocke", 190, "main_event_0900.amx", 6103, 2, Slot("item", "Revive", 6104, 28)),
        Gift("bea-stow-on-side-tm42", "bea", "Bea", "Bea (Stow-on-Side Gym)", "Stow-on-Side Stadium", 200, "main_event_0990.amx", 7558, 1, Slot("item", "TM42", 7559, 369), ProjectGame.Sword),
        Gift("allister-stow-on-side-tm77", "allister", "Allister", "Allister (Stow-on-Side Gym)", "Stow-on-Side Stadium", 200, "main_event_1000.amx", 7519, 1, Slot("item", "TM77", 7520, 404), ProjectGame.Shield),
        Gift("sonia-stow-on-side-revive", "sonia", "Sonia", "Sonia (Stow-on-Side)", "Stow-on-Side", 210, "main_event_1110.amx", 5246, 2, Slot("item", "Revive", 5247, 28)),
        Gift("opal-ballonlea-tm87", "opal", "Opal", "Opal (Ballonlea Gym)", "Ballonlea Stadium", 220, "main_event_1140.amx", 7937, 1, Slot("item", "TM87", 7938, 414)),
        Gift("gordie-circhester-tm48", "gordie", "Gordie", "Gordie (Circhester Gym)", "Circhester Stadium", 230, "main_event_1242.amx", 7508, 1, Slot("item", "TM48", 7509, 375), ProjectGame.Sword),
        Gift("melony-circhester-tm27", "melony", "Melony", "Melony (Circhester Gym)", "Circhester Stadium", 230, "main_event_1252.amx", 7586, 1, Slot("item", "TM27", 7587, 354), ProjectGame.Shield),
        Gift("bike-doctor-route-9-rotom-bike", "bike-doctor", "Bike Doctor", "Bike Doctor (Route 9)", "Route 9", 240, "main_event_1300.amx", 6809, 1, Slot("item", "Rotom Bike", 6810, 1266)),
        Gift("piers-spikemuth-tm85", "piers", "Piers", "Piers (Spikemuth Gym)", "Spikemuth", 250, "main_event_1390.amx", 6062, 1, Slot("item", "TM85", 6063, 412)),
        Gift("raihan-hammerlocke-tm99", "raihan", "Raihan", "Raihan (Hammerlocke Gym)", "Hammerlocke Stadium", 260, "main_event_1430.amx", 8599, 1, Slot("item", "TM99", 8600, 693)),
        Gift("sonia-slumbering-weald-max-revive", "sonia", "Sonia", "Sonia (Slumbering Weald)", "Slumbering Weald", 270, "main_event_1820.amx", 6775, 3, Slot("item", "Max Revive", 6776, 29)),
        Gift("sonia-postgame-book", "sonia", "Sonia", "Sonia (Postgame Slumbering Weald)", "Slumbering Weald", 280, "main_event_3010.amx", 7617, 1, Slot("item", "Sonia's Book", 7618, 1271)),
        ...
        Gift("hulbury-delivery-nugget", "delivery-man", "Delivery Man", "Delivery Man (Hulbury)", "Hulbury", 440, "sub_event_031.amx", 4966, 1, Slot("item", "Nugget", 4967, 92)),
        Gift("hulbury-delivery-big-nugget", "delivery-man", "Delivery Man", "Delivery Man (Hulbury)", "Hulbury", 441, "sub_event_031.amx", 5306, 1, Slot("item", "Big Nugget", 5307, 581)),
        ...
        Gift("pokedex-scientist-mark-charm", "pokedex-scientist", "Pokedex Scientist", "Pokedex Scientist (Isle of Armor)", "Fields of Honor Station", 640, "rigel1_sub_event_001.amx", 6203, 1, Slot("item", "Mark Charm", 6204, 1589)),
        Gift("honey-fruit-bunch", "honey", "Honey", "Honey (Master Dojo ingredients)", "Master Dojo", 650, "rigel1_sub_event_006.amx", 12691, 5, Slot("item", "Fruit Bunch", 12692, 1256)),
        Gift("honey-moomoo-cheese", "honey", "Honey", "Honey (Master Dojo ingredients)", "Master Dojo", 651, "rigel1_sub_event_006.amx", 12707, 5, Slot("item", "Moomoo Cheese", 12708, 1257)),
        Gift("honey-large-leek", "honey", "Honey", "Honey (Master Dojo ingredients)", "Master Dojo", 652, "rigel1_sub_event_006.amx", 12723, 5, Slot("item", "Large Leek", 12724, 1092)),
        Gift("honey-sausages", "honey", "Honey", "Honey (Master Dojo ingredients)", "Master Dojo", 653, "rigel1_sub_event_006.amx", 12739, 5, Slot("item", "Sausages", 12740, 1084)),
        ...
        Gift("bike-lady-black-bike", "bike-lady", "Bike Lady", "Bike Lady (Fields of Honor)", "Fields of Honor", 671, "rigel1_sub_event_012.amx", 2453, 1, Slot("item", "Rotom Bike", 2454, 1586)),
        Gift("bike-lady-water-white-bike", "bike-lady", "Bike Lady", "Bike Lady (Fields of Honor water mode)", "Fields of Honor", 672, "rigel1_sub_event_012.amx", 2490, 1, Slot("item", "Rotom Bike", 2491, 1585)),
        ...
        Gift("peony-freezington-master-ball", "peony", "Peony", "Peony (Freezington)", "Freezington", 693, "rigel02_main_event_0080.amx", 9430, 1, Slot("item", "Master Ball", 9431, 1)),
        ...
        Gift("crown-pokedex-rare-candy", "pokedex-scientist", "Pokedex Scientist", "Pokedex Scientist (Crown Tundra)", "Freezington Station", 760, "rigel2_sub_event_001.amx", 6294, 50, Slot("item", "Rare Candy", 6295, 50)),
        Gift("crown-pokedex-gold-bottle-cap", "pokedex-scientist", "Pokedex Scientist", "Pokedex Scientist (Crown Tundra completion)", "Freezington Station", 761, "rigel2_sub_event_001.amx", 6305, 3, Slot("item", "Gold Bottle Cap", 6306, 796)),
        Gift("peony-expedition-master-ball", "peony", "Peony", "Peony (Dynamax Adventure report)", "Max Lair", 770, "rigel2_sub_event_002.amx", 5195, 1, Slot("item", "Master Ball", 5196, 1)),
    ...
    {
        return Gift(giftId, npcId, npcName, label, location, displayOrder, fileName, quantityCell, quantity, [item], game);
    }
    ...
    private static SwShNpcItemGiftItemSlotDefinition Slot(
        ...
        int itemId)
    {
        return new SwShNpcItemGiftItemSlotDefinition(slotId, label, itemCell, itemId);
    }
