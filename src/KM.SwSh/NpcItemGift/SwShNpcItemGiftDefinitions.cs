...
internal static class SwShNpcItemGiftDefinitions
{
    ...
    [
        ...
        ItemOnlyGift("hammerlocke-soothe-bell", "soothe-bell-npc", "Soothe Bell NPC", "Soothe Bell NPC (Hammerlocke)", "Hammerlocke", 355, "sub_event_016.amx", Slot("item", "Soothe Bell", 4961, 218)),
        ...
        ItemOnlyGift("flying-taxi-npc-tm06", "flying-taxi-npc", "Flying Taxi NPC", "Flying Taxi NPC (Hammerlocke)", "Hammerlocke", 375, "sub_event_019.amx", Slot("item", "TM06", 4961, 333)),
        ItemOnlyGift("screech-npc-tm16", "screech-npc", "Screech NPC", "Screech NPC (Circhester)", "Circhester", 376, "sub_event_020.amx", Slot("item", "TM16", 4961, 343)),
        ...
        ItemOnlyGift("fake-tears-npc-tm47", "fake-tears-npc", "Fake Tears NPC", "Fake Tears NPC (Circhester)", "Circhester", 391, "sub_event_023.amx", Slot("item", "TM47", 4961, 374)),
        ItemOnlyGift("secret-beach-npc-tm45", "secret-beach-npc", "Secret Beach NPC", "Secret Beach NPC (Route 9)", "Route 9", 392, "sub_event_024.amx", Slot("item", "TM45", 4968, 372)),
        ...
        ItemOnlyGift("wild-area-star-piece", "star-piece-npc", "Star Piece NPC", "Star Piece NPC (Wild Area)", "Wild Area", 438, "sub_event_027.amx", Slot("item", "Star Piece", 4961, 91)),
        ...
        ItemOnlyGift("stow-on-side-gym-npc-tm42", "stow-on-side-gym-npc", "Stow-on-Side Gym NPC", "Stow-on-Side Gym NPC (TM42)", "Stow-on-Side", 451, "sub_event_029.amx", Slot("item", "TM42", 4987, 369), ProjectGame.Sword),
        ItemOnlyGift("stow-on-side-gym-npc-tm77", "stow-on-side-gym-npc", "Stow-on-Side Gym NPC", "Stow-on-Side Gym NPC (TM77)", "Stow-on-Side", 451, "sub_event_029.amx", Slot("item", "TM77", 4967, 404), ProjectGame.Shield),
        ItemOnlyGift("circhester-gym-npc-tm48", "circhester-gym-npc", "Circhester Gym NPC", "Circhester Gym NPC (TM48)", "Circhester", 452, "sub_event_030.amx", Slot("item", "TM48", 4987, 375), ProjectGame.Sword),
        ItemOnlyGift("circhester-gym-npc-tm27", "circhester-gym-npc", "Circhester Gym NPC", "Circhester Gym NPC (TM27)", "Circhester", 452, "sub_event_030.amx", Slot("item", "TM27", 4967, 354), ProjectGame.Shield),
