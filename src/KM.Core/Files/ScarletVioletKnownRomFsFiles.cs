...
public static class ScarletVioletKnownRomFsFiles
{
    ...
    [
        ...
        "message/dat/English/common/itemname.tbl",
        "message/dat/English/common/monsname.dat",
        "message/dat/English/common/monsname.tbl",
        "message/dat/English/common/tokusei.dat",
        "message/dat/English/common/tokusei.tbl",
        "message/dat/English/common/place_name.dat",
        "message/dat/English/common/place_name.tbl",
        "message/dat/English/common/trname.dat",
        "message/dat/English/common/trname.tbl",
        "message/dat/English/common/trtype.dat",
        "message/dat/English/common/trtype.tbl",
        "message/dat/English/common/wazaname.dat",
        "message/dat/English/common/wazaname.tbl",
        "message/dat/English/common/trmsg.dat",
        "message/dat/English/common/trmsg.tbl",
    ];
}
