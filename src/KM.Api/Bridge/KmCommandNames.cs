...
public static class KmCommandNames
{
    ...
    public const string LoadTrainerPoolsWorkflow = "trainerPools.load";
    public const string StageTrainerPoolFixedCountSwap = "trainerPools.fixedCountSwap.stage";
    public const string LoadFashionCatalogWorkflow = "fashionCatalog.load";
    public const string StageFashionCatalogFieldEdit = "fashionCatalog.field.stage";
    ...
    public const string StageGiftPokemonVanilla = "giftPokemon.gift.vanilla.stage";
    ...
    public const string UpdateStaticEncounterFields = "staticEncounters.fields.update";
    ...
    public const string PrepareRowClipboardCopy = "rowClipboard.copy.prepare";
    public const string PreviewRowClipboardPaste = "rowClipboard.paste.preview";
    public const string StageRowClipboardPaste = "rowClipboard.paste.stage";
    public const string ClearRowClipboardAuthorizations = "rowClipboard.authorizations.clear";
    ...
    public const string LoadBattleCafeRewardsWorkflow = "battleCafeRewards.load";
    public const string StageBattleCafeRewardRows = "battleCafeRewards.rows.stage";
    ...
    public const string ReadProjectSourceRevision = "project.sourceRevision.read";
