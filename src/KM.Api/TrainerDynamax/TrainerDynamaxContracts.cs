...
public sealed record TrainerDynamaxTrainerDto(int TrainerId, string Name);
public sealed record TrainerDynamaxSettingsDto(bool DisablePlayer, bool DisableOpponents, IReadOnlyList<TrainerDynamaxOverrideDto>? Trainers = null);
