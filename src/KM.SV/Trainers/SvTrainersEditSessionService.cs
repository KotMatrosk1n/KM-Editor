...
internal sealed class SvTrainersEditSessionService
{
    ...
    public ApplyResult ApplyChangePlan(ProjectPaths paths, EditSession session, ChangePlan reviewedPlan)
    {
        ...
        try
        {
            ...
            SvWorkflowFileSource.Write(paths, SvDataPaths.TrainerDataArray, WriteRows(rows));
            writtenFiles.Add(SvEditSessionSupport.GeneratedReference(SvDataPaths.TrainerDataArray));
            writtenFiles.Add(SvEditSessionSupport.GeneratedDescriptorReference());
            diagnostics.Add(SvEditSessionSupport.CreateDiagnostic(
                DiagnosticSeverity.Info,
                "Applied Trainers change plan and patched the Scarlet/Violet Trinity descriptor.",
                SvEditSessionSupport.TrainersDomain));
        }
