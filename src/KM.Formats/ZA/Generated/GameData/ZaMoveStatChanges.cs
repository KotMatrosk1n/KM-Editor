...
public struct ZaMoveStatChanges : IFlatbufferObject
{
  ...
  public static Offset<ZaMoveStatChanges> CreateZaMoveStatChanges(FlatBufferBuilder builder, sbyte Stat1, sbyte Stat2, sbyte Stat3, sbyte Stat1Stage, sbyte Stat2Stage, sbyte Stat3Stage, byte Stat1Chance, byte Stat2Chance, byte Stat3Chance) {
    builder.Prep(1, 9);
