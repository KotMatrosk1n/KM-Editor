...
public struct ZaDressUpCatalogEntry : IFlatbufferObject
{
    ...
    public uint DisplayOrder => ReadUInt(22);
    public bool HasDisplayOrder => Has(22);
    public uint VariantOrder => ReadUInt(24);
    public bool HasVariantOrder => Has(24);
    public string? AlternateModelVariant => ReadString(26);
    public bool HasAlternateModelVariant => Has(26);
