...
public struct SvMoveStatChanges : IFlatbufferObject
{
  ...
  public static Offset<SvMoveStatChanges> CreateSvMoveStatChanges(FlatBufferBuilder builder, sbyte Stat1, sbyte Stat1Stage, byte Stat1Chance, sbyte Stat2, sbyte Stat2Stage, byte Stat2Chance, sbyte Stat3, sbyte Stat3Stage, byte Stat3Chance) {
    builder.Prep(1, 9);
