...
public struct SvMoveData : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_25_2_10(); }
  public static SvMoveData GetRootAsSvMoveData(ByteBuffer _bb) { return GetRootAsSvMoveData(_bb, new SvMoveData()); }
  public static SvMoveData GetRootAsSvMoveData(ByteBuffer _bb, SvMoveData obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public SvMoveData __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public SvMoveInflict? Inflict { get { int o = __p.__offset(26); return o != 0 ? (SvMoveInflict?)(new SvMoveInflict()).__assign(o + __p.bb_pos, __p.bb) : null; } }
  ...
  public SvMoveStatChanges? StatChanges { get { int o = __p.__offset(40); return o != 0 ? (SvMoveStatChanges?)(new SvMoveStatChanges()).__assign(o + __p.bb_pos, __p.bb) : null; } }
  ...
  public static void AddInflict(FlatBufferBuilder builder, Offset<SvMoveInflict> inflictOffset) { builder.AddStruct(11, inflictOffset.Value, 0); }
  ...
  public static void AddStatChanges(FlatBufferBuilder builder, Offset<SvMoveStatChanges> statChangesOffset) { builder.AddStruct(18, statChangesOffset.Value, 0); }
  ...
  public static Offset<SvMoveData> EndSvMoveData(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SvMoveData>(o);
  }
}


static public class SvMoveDataVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 26 /*Inflict*/, 6 /*SvMoveInflict*/, 2, false)
      ...
      && verifier.VerifyField(tablePos, 40 /*StatChanges*/, 9 /*SvMoveStatChanges*/, 1, false)
