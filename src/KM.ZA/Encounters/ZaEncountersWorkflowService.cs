...
internal sealed class ZaEncountersWorkflowService
{
        ...
        ZaPokemonAvailability pokemonAvailability)
    {
        ...
        [
            ...
            new(StrengthenHpField, "HP multiplier", "integer", MinimumStrengthenValue, MaximumStrengthenHpValue, Array.Empty<ZaEncounterEditableFieldOption>()),
            new(StrengthenAttackField, "Attack multiplier", "integer", MinimumStrengthenValue, MaximumStrengthenOtherValue, Array.Empty<ZaEncounterEditableFieldOption>()),
            new(StrengthenDefenseField, "Defense multiplier", "integer", MinimumStrengthenValue, MaximumStrengthenOtherValue, Array.Empty<ZaEncounterEditableFieldOption>()),
            new(StrengthenSpecialAttackField, "Sp. Atk multiplier", "integer", MinimumStrengthenValue, MaximumStrengthenOtherValue, Array.Empty<ZaEncounterEditableFieldOption>()),
            new(StrengthenSpecialDefenseField, "Sp. Def multiplier", "integer", MinimumStrengthenValue, MaximumStrengthenOtherValue, Array.Empty<ZaEncounterEditableFieldOption>()),
            new(StrengthenSpeedField, "Speed multiplier", "integer", MinimumStrengthenValue, MaximumStrengthenOtherValue, Array.Empty<ZaEncounterEditableFieldOption>()),
