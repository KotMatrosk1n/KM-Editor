...
internal static class ZaScriptedBossActionCatalog
{
    ...
    [
        ...
        ScriptedFollowerProfile(
            "688:0:boss_0689:follower",
            "boss_0689_follower_binacle",
            688,
            0,
            SelectorBattleMove(22254, 55, NormalMoveVariant),
            SelectorBattleMove(22255, 163, NormalMoveVariant),
            SelectorBattleMove(22256, 523, NormalMoveVariant)),
        Profile(701, 1,
            BattleMove(332),
            BattleMove(280),
            BattleMove(403),
