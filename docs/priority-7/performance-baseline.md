...
- Individual workflow loads for Items, Pokemon Data, Moves Data, Text, Trainers, Gifts, Trades, Static Encounters, Rentals, Dynamax Adventures, Shops, Encounters, Raid Battles, Raid Rewards, Placement, Flagwork/Save, ExeFS Patches, Royal Candy, and Spreadsheet Import.
