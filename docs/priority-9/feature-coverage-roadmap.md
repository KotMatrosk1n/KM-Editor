...
| Trainers | Trainer class, money, mode, items, AI flags, class ball, party slots, species/form/level/ability/item/nature/gender/shiny/EVs/IVs/Dynamax/Gigantamax/moves, bulk helpers | Trainer class and party species/form/level/item/move/stat/flag editing is guarded by preview/validate/apply; IVs, EVs, nature, gender, shiny, Dynamax, Gigantamax, and named class/species/item/move selectors are covered | Expand remaining trainer metadata, money/item/class-ball/AI flag fields, battle-mode labels, and bulk helpers |
...
2. Individual Pokemon stat editing across trainer parties first, then gifts/trades/statics/rentals/Dynamax Adventures, with IV handling treated as a required shared capability. Trainer-party IV/stat editing and core class/species/item/move selectors are covered; continue with remaining trainer metadata and other individual-Pokemon workflows.
