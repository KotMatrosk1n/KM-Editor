...
const editorSurfaceInventory = {
  ...
  trainerDynamax: ['src/features/trainer-dynamax/TrainerDynamaxSection.tsx', 'TrainerDynamaxSection', 'choice-local-draft'],
...
const embeddedEditableSurfaceInventory = {
  ...
  modelParts: ['src/features/model-viewer/ModelWorkspaceTools.tsx', 'ModelParts', 'utility-input'],
  modelFrameInput: ['src/features/model-viewer/ModelWorkspaceTools.tsx', 'ModelFrameInput', 'utility-input'],
  modelTextureInspector: ['src/features/model-viewer/ModelTextureInspector.tsx', 'ModelTextureInspector', 'utility-input'],
...
const editorDraftContractInventory = {
  ...
  marnieBoosts: 'source-reconciled-exact-submit',
  raidDens: 'source-reconciled-exact-submit',
  trainerWhiteout: 'source-reconciled-exact-submit',
  trainerDynamax: 'captured-review',
