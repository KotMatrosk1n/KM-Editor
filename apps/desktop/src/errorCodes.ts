...
export const projectBridgeErrorCodes = {
  ...
  projectSupportRequired: "KM-PROJECT-SUPPORT-REQUIRED",
  projectSupportWrongKind: "KM-PROJECT-SUPPORT-WRONG-KIND",
  projectSupportFolderMissing: "KM-PROJECT-SUPPORT-FOLDER-MISSING",
  projectSupportFileMissing: "KM-PROJECT-SUPPORT-FILE-MISSING",
...
export const mergeWorkspaceErrorCodes = {
  archiveUnreadable: "KM-MERGE-ARCHIVE-UNREADABLE",
  baseMissing: "KM-MERGE-BASE-MISSING",
  descriptorMismatch: "KM-MERGE-DESCRIPTOR-MISMATCH",
  descriptorRequired: "KM-MERGE-DESCRIPTOR-REQUIRED",
  duplicatePath: "KM-MERGE-DUPLICATE-PATH",
  packagesRequired: "KM-MERGE-PACKAGES-REQUIRED",
  packagesStale: "KM-MERGE-PACKAGES-STALE",
  packageManifestInvalid: "KM-MERGE-PACKAGE-MANIFEST-INVALID",
  packageSelectionInvalid: "KM-MERGE-PACKAGE-SELECTION-INVALID",
  exportFailed: "KM-MERGE-EXPORT-FAILED",
  formatOpaque: "KM-MERGE-FORMAT-OPAQUE",
  semanticInvalid: "KM-MERGE-SEMANTIC-INVALID",
  patchInvalid: "KM-MERGE-PATCH-INVALID",
  executableBaseRequired: "KM-MERGE-EXECUTABLE-BASE-REQUIRED",
  gameMismatch: "KM-MERGE-GAME-MISMATCH",
  gameUnknown: "KM-MERGE-GAME-UNKNOWN",
  limitExceeded: "KM-MERGE-LIMIT-EXCEEDED",
  mixedGames: "KM-MERGE-MIXED-GAMES",
  outputConflict: "KM-MERGE-OUTPUT-CONFLICT",
  outputRecovery: "KM-MERGE-OUTPUT-RECOVERY",
  outputUnavailable: "KM-MERGE-OUTPUT-UNAVAILABLE",
  packedLayout: "KM-MERGE-PACKED-LAYOUT",
  packedOverlap: "KM-MERGE-PACKED-OVERLAP",
  pathUnsafe: "KM-MERGE-PATH-UNSAFE",
  pickerFailed: "KM-MERGE-PICKER-FAILED",
  requestInvalid: "KM-MERGE-REQUEST-INVALID",
  reviewStale: "KM-MERGE-REVIEW-STALE",
  supportRequired: "KM-MERGE-SUPPORT-REQUIRED",
  vanillaRequired: "KM-MERGE-VANILLA-REQUIRED",
} as const;
