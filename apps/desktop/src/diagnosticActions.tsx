...
const projectCodes = new Set<string>([
  ...
  projectBridgeErrorCodes.projectSupportRequired,
  projectBridgeErrorCodes.projectSupportWrongKind,
  projectBridgeErrorCodes.projectSupportFolderMissing,
  projectBridgeErrorCodes.projectSupportFileMissing,
