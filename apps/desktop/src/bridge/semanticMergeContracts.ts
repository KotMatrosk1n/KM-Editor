...
export const semanticMergeExpectedIndexedRows = 50_000;
export const semanticMergeProvisionedIndexedRows = semanticMergeExpectedIndexedRows * 4;
export const semanticMergeMaximumIndexedRows = semanticMergeProvisionedIndexedRows * 2;
...
export const kmRecipeExpectedBytes = 4 * 1_024 * 1_024;
export const kmRecipeProvisionedBytes = kmRecipeExpectedBytes * 4;
export const kmRecipeMaximumBytes = kmRecipeProvisionedBytes * 2;
export const kmRecipeExpectedOperations = 768;
export const kmRecipeProvisionedOperations = kmRecipeExpectedOperations * 4;
export const kmRecipeMaximumOperations = kmRecipeProvisionedOperations * 2;
export const kmRecipeExpectedSteps = 64;
export const kmRecipeProvisionedSteps = kmRecipeExpectedSteps * 4;
export const kmRecipeMaximumSteps = kmRecipeProvisionedSteps * 2;
