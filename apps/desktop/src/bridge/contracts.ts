...
export const kmCommandNames = {
  ...
  soundStudio: "audio.studio",
  modelCatalog: "models.catalog",
  modelPrepare: "models.prepare",
  modelTextures: "models.textures",
  modelTextureStage: "models.textures.stage",
  modelProperties: "models.properties",
  modelAssetStage: "models.assets.stage",
  ...
  loadStarmobiles: "starmobiles.load",
  stageStarmobiles: "starmobiles.fields.stage",
  ...
  loadMarnieBoosts: "marnieBoosts.load",
  loadRaidDens: "raidDens.load",
  loadTrainerWhiteout: "trainerWhiteout.load",
  stageMarnieBoosts: "marnieBoosts.stage",
  stageRaidDens: "raidDens.stage",
  stageTrainerWhiteout: "trainerWhiteout.stage",
  loadProfanityFilter: "profanityFilter.load",
  loadTrainerDynamax: "trainerDynamax.load",
  reviewTrainerDynamax: "trainerDynamax.review",
  applyTrainerDynamax: "trainerDynamax.apply",
  ...
  inspectInGameSettingsPackage: "inGameSettingsPackage.inspect",
  previewInGameSettingsPackage: "inGameSettingsPackage.preview",
  applyInGameSettingsPackage: "inGameSettingsPackage.apply",
...
export const itemMetadataSchema = z.strictObject({
  ...
  isOwnedTechnicalMachineSlot: z.boolean().optional().default(false),
...
export const encounterSlotRecordSchema = z.strictObject({
  ...
  encounterActivationConditions: z.array(z.string()).nullable().optional(),
  form: z.number().int(),
  ...
  ivAttack: z.number().int().nullable().optional(),
  ivDefense: z.number().int().nullable().optional(),
  ivHp: z.number().int().nullable().optional(),
  ivSpecialAttack: z.number().int().nullable().optional(),
  ivSpecialDefense: z.number().int().nullable().optional(),
  ivSpeed: z.number().int().nullable().optional(),
  levelMax: z.number().int().nonnegative(),
  levelMin: z.number().int().nonnegative(),
  moveIds: z.array(z.number().int()).length(4).nullable().optional(),
  nature: z.number().int().nullable().optional(),
  revertToVanillaBlockedReason: z.string().nullable().optional(),
  shinyMode: z.number().int().nullable().optional(),
  slot: z.number().int().nonnegative(),
