...
namespace KM.Integration.Tests.DataCoverage;

public sealed class EditorDataCoverageTests
{
    private static readonly IReadOnlyDictionary<string, ulong> ExpectedScarletVioletFileHashes =
        new Dictionary<string, ulong>(StringComparer.Ordinal)
        {
            ...
            [SvDataPaths.EvolutionItemConversionArray] = 0xABE8276CA78BEAF8,
    ...
    private static readonly IReadOnlyDictionary<string, ulong> ExpectedPokemonLegendsZAFileHashes =
        new Dictionary<string, ulong>(StringComparer.Ordinal)
        {
            ...
            [ZaDataPaths.EvolutionItemConversionArray] = 0x9DF453541EE1276F,
    ...
    [Fact]
    public void ScarletVioletDataPathsMatchExpectedFileHashes()
    {
        AssertDataPathHashes(
            EnumerateDataPathConstants(typeof(SvDataPaths), IsScarletVioletDataPath),
            ExpectedScarletVioletFileHashes,
            SvTrinityPathHasher.HashPath);
    }

    [Fact]
    public void PokemonLegendsZADataPathsMatchExpectedFileHashes()
    {
        AssertDataPathHashes(
            EnumerateDataPathConstants(typeof(ZaDataPaths), IsPokemonLegendsZADataPath),
            ExpectedPokemonLegendsZAFileHashes,
            ZaTrinityPathHasher.HashPath);
    }

    [Fact]
    public void ScarletVioletMessageLanguagesMatchExpectedFolders()
    {
    ...
    [Fact]
    public void PokemonLegendsZAMessageLanguagesMatchExpectedFolders()
    {
    ...
    [Fact]
    public void ScarletVioletRaidSourcesMatchExpectedLayout()
    {
        ...
        {
            Assert.True(ExpectedScarletVioletFileHashes.ContainsKey(source.VirtualPath), source.VirtualPath);
        }
