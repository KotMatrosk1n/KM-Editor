...
internal static class SwShPlacementBridgeFixtures
{
    ...
    public static void WriteBasePlacement(TemporaryBridgeProject temp)
    {
        ...
        temp.WriteBaseRomFsFile(
            ...
            [
                ...
                new SwShGameTextLine("Great Ball", Flags: 0),
            ]));
    }
    ...
    public static SwShPlacementZoneArchive CreatePlacementArchive()
    {
        ...
        Description: "sanitized placement bridge archive",
        SourceData: []);
    }
}
