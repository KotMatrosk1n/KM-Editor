...
internal static class SwShRaidBattleBridgeFixtures
{
    public const ulong BattleTableId = 0xAABBCCDD00112233;

    public static void WriteBaseRaidBattles(TemporaryBridgeProject temp)
    {
            ...
            new SwShEncounterNestTable(
                ...
                [
                    new SwShEncounterNest(
                        ...
                        SwShRaidRewardBridgeFixtures.BonusTableId,
                        [100, 20, 30, 40, 50],
                        1,
                        4),
                    new SwShEncounterNest(
