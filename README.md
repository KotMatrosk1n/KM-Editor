...
- Supports Bag Hook, Royal Candy, Starting Items, Catch Cap, Hyper Training, Type Chart, IV Screen, and Gym Uniform Removal through documented ownership rules.
...
Catch Cap Editor, Hyper Training, Type Chart, IV Screen, and Gym Uniform Removal are available as Advanced Editors with documented Sword/Shield ExeFS ownership rules. Randomizer is available under Tools with shareable seeds for reproducible output. Rental Pokemon and Dynamax Adventures remain hidden as work in progress until their runtime safety work is finished. See the [Hook Architecture wiki page](https://github.com/KotMatrosk1n/KM-Editor/wiki/Hook-Architecture), [Randomizer](https://github.com/KotMatrosk1n/KM-Editor/wiki/Randomizer), [Type Chart](https://github.com/KotMatrosk1n/KM-Editor/wiki/Type-Chart), [Gym Uniform Removal](https://github.com/KotMatrosk1n/KM-Editor/wiki/Gym-Uniform-Removal), [Rental Pokemon Editor](https://github.com/KotMatrosk1n/KM-Editor/wiki/Rental-Pokemon-Editor), and [Dynamax Adventures Editor](https://github.com/KotMatrosk1n/KM-Editor/wiki/Dynamax-Adventures-Editor).
