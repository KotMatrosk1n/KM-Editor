...
5. Make and save edits into the current session.
6. Open **Changes**, validate the session, review the target files, and choose the output mode for that game.
...
| --- | --- | --- | --- |
| Sword and Shield | Pokemon, moves, items, trainers, text, encounters, raids, shops, rewards, and placement | ExeFS and hook based editors, Randomizer, Mod Merger, Game Dump, and Dump Importer | [Sword and Shield overview](https://github.com/KotMatrosk1n/KM-Editor/wiki/Sword-and-Shield-Overview) |
...
- Normal edits are staged before output and can be removed or validated individually.
